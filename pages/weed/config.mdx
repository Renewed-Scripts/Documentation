...
This configuration controls settings for the plants such as how long they take to grow or how much water they require.
...
return {
    ...
    -- Brick Config --
    driedWeight = 1000, -- How much does 1 dried weed weight? if you change it inside your inventory change it here for the weed bricks
    ...
    secondsToDecay = 7200, -- How many seconds does it take for a plant to decay down to dried weed? (Default 7200 seconds = 2 hours)
...
You can add/remove possible names for your weed strains here.
...
This configuration controls the weed runs
...
return {
    ...
    -- START SETTINGS --
    needWeedbrick = false, -- Set this to true if you want the player to need a weed brick to start the run
