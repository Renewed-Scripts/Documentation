...
Here you will get a brief and precise tutorial on how to install Renewed Weed for your server!

## Step 1
Head over to `ox_inventory/data/items.lua` and paste the following items in!
