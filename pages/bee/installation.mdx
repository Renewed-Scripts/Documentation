...
Head over to `ox_inventory/data/items.lua` and paste in these items. Adjust the weights etc. to your liking
...
Head over to ox_inventory/web/images and paste in the images from Renewed-Beekeeping/images
