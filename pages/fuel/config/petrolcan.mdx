...
In order to use petrol cans properly, make sure you have done the inventory edits in the [installation section](../Setup/petrolcans).

```lua copy filename="shared/petrolcan.lua"
